...
import com.nabob.conch.geo.dingtalk.SendTextMessageWarning;
 ...
 */
@Configuration
@EnableConfigurationProperties(ConchGeoJobProperties.class)
public class ConchGeoAutoConfiguration {
    private final static Logger LOG = LoggerFactory.getLogger(ConchGeoAutoConfiguration.class);
    ...
    @Bean
    @ConditionalOnMissingBean
    public JobManager jobManager(ConchGeoJobProperties conchGeoJobProperties, LocationParserEngine engine,
                                 AreaAvailable areaAvailable, SendTextMessageWarning sendTextMessageWarning) {
        return new JobManager(
                new ThreadPoolExecutor(conchGeoJobProperties.getManager().getCorePoolSize(),
                        conchGeoJobProperties.getManager().getMaximumPoolSize(),
                        conchGeoJobProperties.getManager().getKeepAliveTime(), TimeUnit.SECONDS,
